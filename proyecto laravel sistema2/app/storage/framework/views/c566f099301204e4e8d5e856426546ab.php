    ...
    <table class="l">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col1-"><a href="editciudad/<?php echo e($c->id); ?>" class="btn btn-sm-primary">Editar</a><td>
                <td class="col-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Caty_php\sistema2-app\resources\views/cuidad/index.blade.php ENDPATH**/ ?>